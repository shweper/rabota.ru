...
def invite():
   ...
   # try:
    ...
    #except:
     #   print('на странице нет действуюих вакансий')
      #  Keys.LEFT_ALT + Keys.ARROW_LEFT
...
def main():
    ...
    for n in range(100):
        ...
        try:
            ...
            tdss = tds[1].find_element_by_tag_name('a')
            print(' дошёл до условия 1')
            ...
            try:
                ...
                time.sleep(1)
                try:
                    tdss2 = tds[2].find_element_by_tag_name('a')
                    print(' дошёл до условия 2')
                    if tdss2 != None:
                        tdss2.click()
...
while n < 100:
    ...
    #print(tds)
    try:
        tdss = tds[1].find_element_by_tag_name('a').click()
        time.sleep(1)
        invite()
        browser.find_element_by_xpath('/html/body/div[2]/div[1]/div[2]/ul/li[2]/a').click()
        print(tdss)
        otvet_tru.append(tdss)
    except:
        print("1 none")
    try:

            tdss = tds[2].find_element_by_tag_name('a').click()
            invite()
            browser.find_element_by_xpath('/html/body/div[2]/div[1]/div[2]/ul/li[2]/a').click()
            print(tdss)
            otvet_tru.append(tdss)
