...
while vsego <= 1500:
    ...
    while iteracia < script3.high_number_gorod:
        ...
        while iteracia < len(script3.goroda_arr[iter_gorod]):
            ...
            browser.get(
                'https://nn.rabota.ru/v3_myVacancy.html?action=create&company_registered=true&employer_registered=true')
            error_string = 1119
                ...
                while qwert <= 0:
                    ...
                    try:
                        browser.find_element_by_xpath(
                            '/html/body/div[4]/div[1]/div/div[2]/div/label[' + str(qwer) + ']/input[2]').send_keys(
                            spec1)
                        browser.find_element_by_xpath(
                            '//*[@id="jqmContent"]/div/div[2]/div/label[' + str(qwer) + ']/input[3]').click()
                        qwert += 1
                    except:
                ...
                while qwert <= 1:
                    try:
                        browser.find_element_by_xpath(
                            ...
                            spec2)
                        browser.find_element_by_xpath(
                            '/html/body/div[4]/div[1]/div/div[2]/div/label[' + str(qwer) + ']/input[3]').click()
                        qwert += 1
                    except:
                        qwesadqwdsa = 2
                    qwer += 1
            ...
            browser.find_element_by_xpath('//*[@id="employer_requirements"]/div/div/table/tbody/tr[7]/td[2]/div[1]/div/div/div/div/div/select').click()
            if obraz == "высшее":
                browser.find_element_by_xpath('//*[@id="employer_requirements"]/div/div/table/tbody/tr[7]/td[2]/div[1]/div/div/div/div/div/select/option[2]').click()
            elif obraz == "неполное высшее":
                browser.find_element_by_xpath('//*[@id="employer_requirements"]/div/div/table/tbody/tr[7]/td[2]/div[1]/div/div/div/div/div/select/option[3]').click()
            elif obraz == "среднее профессиональное":
                browser.find_element_by_xpath('//*[@id="employer_requirements"]/div/div/table/tbody/tr[7]/td[2]/div[1]/div/div/div/div/div/select/option[4]').click()
            elif obraz == "среднее":
                browser.find_element_by_xpath('//*[@id="employer_requirements"]/div/div/table/tbody/tr[7]/td[2]/div[1]/div/div/div/div/div/select/option[5]').click()
            elif obraz == "любое":
                browser.find_element_by_xpath('//*[@id="employer_requirements"]/div/div/table/tbody/tr[7]/td[2]/div[1]/div/div/div/div/div/select/option[1]').click()
            ...
            if pens != None:
                browser.find_element_by_xpath(  '//*[@id="vacancyForm"]/div[4]/div/table/tbody/tr[1]/td[2]/div/div/div[1]/label/input').click()
            if stud != None:
                browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[4]/div/table/tbody/tr[1]/td[2]/div/div/div[2]/label/input').click()
            #if drug_gor != None:
            #   browser.find_element_by_xpath( '//*[@id="vacancyForm"]/div[4]/div/table/tbody/tr[3]/td[2]/div/div/div[3]/label/input').click()
            if invalid != None:
                browser.find_element_by_xpath( '//*[@id="vacancyForm"]/div[4]/div/table/tbody/tr[1]/td[2]/div/div/div[3]/label/input').click()
            #if migrant != None:
            #    browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[4]/div/table/tbody/tr[3]/td[2]/div/div/div[5]/label/input').click()
            ...
            name_hr_bar_xpath = '//*[@id="vacancyForm"]/div[6]/div/div/table/tbody/tr[1]/td[2]/div/input'
            ...
            if nazvanie != None:
                browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[7]/div/div/table[2]/tbody/tr[3]/td[2]/div/label/input').click()
                try:
                    browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[7]/div/div/table[2]/tbody/tr[3]/td[2]/span/input').send_keys(nazvanie)
                except:
                    time.sleep(1)
                    browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[7]/div/div/table[2]/tbody/tr[3]/td[2]/span/input').send_keys(nazvanie)
            ...
            # time.sleep(3)
            # print('ВАЖНО!111')
            browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[7]/div/div/table[1]/tbody/tr/td[2]/div[1]/a').click()
            ...
            if grafik == 'полный рабочий день':
                browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[5]/div[2]/div/table/tbody/tr[2]/td[2]/div[1]/div[1]/label/input').click()
            elif grafik == 'сменный график':
                browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[5]/div[2]/div/table/tbody/tr[2]/td[2]/div[1]/div[2]/label/input').click()
            elif grafik == 'свободный график':
                browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[5]/div[2]/div/table/tbody/tr[2]/td[2]/div[1]/div[3]/label/input').click()
            elif grafik == 'частичная занятость':
                browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[5]/div[2]/div/table/tbody/tr[2]/td[2]/div[1]/div[4]/label/input').click()
            elif grafik == 'удаленная работа':
                browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[5]/div[2]/div/table/tbody/tr[2]/td[2]/div[1]/div[5]/label/input').click()
            elif grafik == 'вахта':
                browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[5]/div[2]/div/table/tbody/tr[2]/td[2]/div[1]/div[6]/label/input').click()
            ...
            if oformlenie != None:
                browser.find_element_by_xpath('//*[@id="vacancyForm"]/div[7]/div/div/table[2]/tbody/tr[4]/td[2]/div/div[1]/label/input').click()
                time.sleep(1)
                try:
                ...
                #    browser.find_element_by_xpath('/html/body/div[4]/div[1]/div/div[2]/div[1]/a').click()
                    ...
                    if oformlenie == "Шаблон АМБЕР1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[1]/li[1]/a').click()
                    elif oformlenie == "Шаблон Наземное такси1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[1]/li[2]/a').click()
                    elif oformlenie == "Шаблон Наземное такси2":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[1]/li[3]/a').click()
                    elif oformlenie == "Шаблон Наземное такси3":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[1]/li[4]/a').click()
                    elif oformlenie == "Шаблон АМБЕР2":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[1]/li[5]/a').click()
                    elif oformlenie == "Шаблон Рестораны / Питание1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[1]/a').click()
                    elif oformlenie == "Шаблон Транспорт / Логистика1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[2]/a').click()
                    elif oformlenie == "Шаблон Охрана и безопасность1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[3]/a').click()
                    elif oformlenie == "Шаблон Рестораны / Питание2":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[4]/a').click()
                    elif oformlenie == "Шаблон Рестораны / Питание3":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[5]/a').click()
                    elif oformlenie == "Шаблон Транспорт / Логистика2":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[6]/a').click()
                    elif oformlenie == "Шаблон Строительство1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[7]/a').click()
                    elif oformlenie == "Шаблон Производство / Агропром1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[8]/a').click()
                    elif oformlenie == "Шаблон Торговля1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[9]/a').click()
                    elif oformlenie == "Шаблон Туризм1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[10]/a').click()
                    elif oformlenie == "Шаблон Строительство2":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[11]/a').click()
                    elif oformlenie == "Шаблон Торговля2":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[12]/a').click()
                    elif oformlenie == "Шаблон Строительство3":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[13]/a').click()
                    elif oformlenie == "Шаблон Туризм2":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[14]/a').click()
                    elif oformlenie == "Шаблон Производство / Агропром2":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[15]/a').click()
                    elif oformlenie == "Шаблон Производство / Агропром3":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[16]/a').click()
                    elif oformlenie == "Шаблон Производство1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[17]/a').click()
                    elif oformlenie == "Шаблон Цветы1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[18]/a').click()
                    elif oformlenie == "Шаблон Швейное производство1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[19]/a').click()
                    elif oformlenie == "Шаблон Медицина1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[20]/a').click()
                    elif oformlenie == "Шаблон кол-центр1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[21]/a').click()
                    elif oformlenie == "Шаблон Офисный персонал1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[22]/a').click()
                    elif oformlenie == "Шаблон Рестораны / Питание4":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[23]/a').click()
                    elif oformlenie == "Шаблон Торговля3":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[24]/a').click()
                    elif oformlenie == "Шаблон Мебельное производство1":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[25]/a').click()
                    elif oformlenie == "Шаблон Работа на АЗС":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[26]/a').click()
                    elif oformlenie == "Шаблон Производство2":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[27]/a').click()
                    elif oformlenie == "Шаблон Производство3":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[28]/a').click()
                    elif oformlenie == "Шаблон Столярное дело":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[29]/a').click()
                    elif oformlenie == "Шаблон Торговля4":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[30]/a').click()
                    elif oformlenie == "Шаблон Транспорт / Логистика3":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[31]/a').click()
                    elif oformlenie == "Шаблон Транспорт / Логистика4":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[32]/a').click()
                    elif oformlenie == "Шаблон Офисный персонал2":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[33]/a').click()
                    elif oformlenie == "Шаблон Торговля5":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[34]/a').click()
                    elif oformlenie == "Шаблон Офисный персонал3":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[35]/a').click()
                    elif oformlenie == "Шаблон Офисный персонал4":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[36]/a').click()
                    elif oformlenie == "Шаблон Охрана и безопасность2":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[37]/a').click()
                    elif oformlenie == "Шаблон Офисный персонал5":
                        browser.find_element_by_xpath(
                            '/html/body/div[6]/div[1]/div/div[2]/div[1]/ul[2]/li[38]/a').click()
            ...
            try:
                ...
                browser.find_element_by_xpath(
                    '/html/body/div[2]/div[2]/div[2]/div[1]/div[4]/div[1]/form/div/div[2]/div[2]/a').click()
            browser.quit()
            print(iteracia)
            # except:
            #    time.sleep(1)
